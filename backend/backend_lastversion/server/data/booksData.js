...
exports.saveBook = function (book) {
    return database.one('insert into livro (descricao, editora, isbn, quantidade, assunto, autor) values ($1, $2, $3, $4, $5, $6) returning *'
    ,[book.descricao, book.editora, book.isbn, book.quantidade, book.assunto, book.autor]);
}
